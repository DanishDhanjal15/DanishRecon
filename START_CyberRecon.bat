...
if not defined DANISHRECON_TWILIO_ACCOUNT_SID set "DANISHRECON_TWILIO_ACCOUNT_SID=YOUR_TWILIO_ACCOUNT_SID"
if not defined DANISHRECON_TWILIO_AUTH_TOKEN set "DANISHRECON_TWILIO_AUTH_TOKEN=YOUR_TWILIO_AUTH_TOKEN"
if not defined DANISHRECON_TWILIO_WHATSAPP_FROM set "DANISHRECON_TWILIO_WHATSAPP_FROM=whatsapp:+14155238886"
if not defined DANISHRECON_TWILIO_WHATSAPP_TO set "DANISHRECON_TWILIO_WHATSAPP_TO=whatsapp:+YOUR_PHONE_NUMBER"
